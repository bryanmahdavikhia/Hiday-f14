...
urlpatterns = [
    ...
    path('list-aset/list-dekorasi/update-dekorasi/', views.update_dekorasi, name='update-dekorasi'),

    path('list-aset/list-bibit-tanaman/', views.list_bibit_tanaman, name='list-bibit-tanaman'),
    path('list-aset/list-bibit-tanaman/update-bibit/', views.update_bibit, name='update-bibit'),

    path('list-aset/list-kandang/', views.list_kandang, name='list-kandang'),
    path('list-aset/list-kandang/update-kandang/', views.update_kandang, name='update-kandang'),

    path('list-aset/list-hewan/', views.list_hewan, name='list-hewan'),
    path('list-aset/list-hewan/update-hewan/', views.update_hewan, name='update-hewan'),

    path('list-aset/list-alat-produksi/', views.list_alat_produksi, name='list-alat'),
    path('list-aset/list-alat-produksi/update-alat/', views.update_alat, name='update-alat'),

    path('list-aset/list-petak-sawah/', views.list_petak_sawah, name='list-petak-sawah'),
    path('list-aset/list-petak-sawah/update-sawah/', views.update_petak_sawah, name='update-petak-sawah')
