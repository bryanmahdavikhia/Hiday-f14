"""
Django settings for TK3_F14 project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-s$yhx7fnl9*c4$a^1zp%yb78vz-%4ldie0)jsa*f(j59y8t(*-')
...
WSGI_APPLICATION = 'TK3_F14.wsgi.application'
